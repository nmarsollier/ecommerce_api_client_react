...
export async function login(payload: ILogin): Promise<IToken> {
  try {
    const res = await axios.post("http://localhost:3000/users/signin", payload);
...
export async function getUsers(): Promise<IUser[]> {
  try {
    const res = await axios.get(environment.authServerUrl + "users/all");
    return Promise.resolve(res.data);
  } catch (err) {
    return Promise.reject(err);
  }
...
export async function enableUser(id: string): Promise<void> {
  try {
    const res = await axios.post(
      environment.authServerUrl + "users/" + id + "/enable"
    );
    return Promise.resolve(res.data);
  } catch (err) {
    return Promise.reject(err);
...
export async function disableUser(id: string): Promise<void> {
  try {
    const res = await axios.post(
      environment.authServerUrl + "users/" + id + "/disable"
    );
    return Promise.resolve(res.data);
  } catch (err) {
    return Promise.reject(err);
...
export async function grant(id: string, permissions: string[]): Promise<void> {
  try {
    const res = await axios.post(
      environment.authServerUrl + "users/" + id + "/grant",
      { permissions }
    );
    return Promise.resolve(res.data);
  } catch (err) {
...
export async function revoke(id: string, permissions: string[]): Promise<void> {
  try {
    const res = await axios.post(
      environment.authServerUrl + "users/" + id + "/revoke",
      { permissions }
    );
    return Promise.resolve(res.data);
  } catch (err) {
